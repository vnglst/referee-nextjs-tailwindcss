...
const navigation = [
  { name: "Ik zoek", href: "#", current: true },
  { name: "Ik bied", href: "#", current: false },
  { name: "Werkwijze", href: "#", current: false },
      ...
      <div className="min-h-full">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                  <div className="flex items-center">
                    <div className="flex-shrink-0 text-gray-300 text-2xl">
                      <GiWhistle />
                    </div>
        ...
        <header className="bg-white shadow">
          <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold text-gray-900">Ik zoek</h1>
          </div>
        </header>
